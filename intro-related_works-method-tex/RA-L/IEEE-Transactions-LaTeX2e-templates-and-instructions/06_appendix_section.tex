...
\par
\appendixablcaption{fig:ablation_visual}{前馈回归器消融的可视化结果。展示代表帧 \texttt{train\_0004}、\texttt{train\_0084}、\texttt{train\_0609} 与 \texttt{train\_0784} 在 0、4、8 次局部优化后的结果；每行左三列为 Baseline，右三列为 Ours。}
\vspace{0.4em}
\end{center}
\end{strip}
