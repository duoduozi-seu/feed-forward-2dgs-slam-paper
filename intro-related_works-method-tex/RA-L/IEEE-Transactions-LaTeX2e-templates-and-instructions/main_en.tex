...
\centering
\begingroup
% 单栏内并排 5 张图时，长方法名会撑宽 tabular；固定单元宽度并拆行，避免越过栏宽。
\def\customqualwidth{0.19\columnwidth}
\newcommand{\customquallabel}[1]{\parbox[c]{\customqualwidth}{\centering\scriptsize #1}}
\begin{tabular}{@{}c@{\hspace{1pt}}c@{\hspace{1pt}}c@{\hspace{1pt}}c@{\hspace{1pt}}c@{}}
\customquallabel{GT} & \customquallabel{MonoGS} & \customquallabel{MM3DGS-\\SLAM} & \customquallabel{Gaussian-\\LIC2} & \customquallabel{Ours} \\
\includegraphics[width=\customqualwidth]{../../../images/compare-custom-2/gt/test_1080.png} &
\includegraphics[width=\customqualwidth]{../../../images/compare-custom-2/monogs/test_1080.jpg} &
\includegraphics[width=\customqualwidth]{../../../images/compare-custom-2/mm3dgs/test_1080.png} &
\includegraphics[width=\customqualwidth]{../../../images/compare-custom-2/gslic2/test_1080.jpg} &
\includegraphics[width=\customqualwidth]{../../../images/compare-custom-2/ours/test_1080.jpg} \\
\end{tabular}
\endgroup
