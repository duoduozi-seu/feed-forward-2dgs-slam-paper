...
\rowcolor{black!8}
\multicolumn{6}{l}{\textbf{Self-Collected Campus Dataset}} \\
...
\begin{tabular}{ccccc}
\small GT & \small MonoGS & \small MM3DGS-SLAM & \small Gaussian-LIC2 & \small Ours \\
\includegraphics[width=0.19\columnwidth]{../../../images/compare-custom-2/gt/test_1080.png} &
\includegraphics[width=0.19\columnwidth]{../../../images/compare-custom-2/monogs/test_1080.jpg} &
\includegraphics[width=0.19\columnwidth]{../../../images/compare-custom-2/mm3dgs/test_1080.png} &
\includegraphics[width=0.19\columnwidth]{../../../images/compare-custom-2/gslic2/test_1080.jpg} &
\includegraphics[width=0.19\columnwidth]{../../../images/compare-custom-2/ours/test_1080.jpg} \\
\end{tabular}
\caption{Qualitative comparison results on our self-collected campus dataset. The example shows frame \texttt{1080} from \texttt{seu\_campus\_seq\_01}. Compared with MonoGS, MM3DGS-SLAM, and Gaussian-LIC2, our method preserves clearer building contours, ground textures, and distant structures, while reducing blur and local distortion.}
\label{fig:qualitative_compare_custom}
\end{figure}

Figure~\ref{fig:qualitative_compare_custom} shows a representative qualitative result on \texttt{seu\_campus\_seq\_01}. In this scene, MonoGS produces obvious blur and structural degradation, while MM3DGS-SLAM recovers a more complete layout but still loses fine details around distant building edges. Gaussian-LIC2 reconstructs the main scene structure, yet remaining smoothing and local distortion can still be observed on the facade boundaries and textured ground areas. Our method preserves sharper building outlines and more stable scene structure, further supporting the quantitative gains on the self-collected sequences.
